...
<body class="hold-transition register-page" style="background-color: #FFF;">
    ...
    <div class="register-box" style="opacity:0.75; background-color: #b3e5c6;">
        <div class="register-logo">
            <p>
                <a href="{{ url('tramite') }}"><b>SISDATA</b></a>
            </p>
        ...
        <div class="register-box-body" style="background-color:transparent !important;">
            <p class="login-box-msg"><b>Reestablecer Contrase&ntilde;a</b></p>
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" class="form-control" name="adm_nombre" id="adm_nombre"
                    value="{{ $user_token->adm_nombre }} {{ $user_token->adm_apellido }}" readonly>
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" placeholder="Confirmar Contraseña" name="repit_password"
            ...
            <div class="social-auth-links text-center">
                <button class="btn btn-success btn-block" type="submit" id="guardar"><i class="fa fa-save"></i>
                    Guardar</button>
