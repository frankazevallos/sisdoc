    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                <span class="logo-lg" style="color: #FFFFF5;"><i class="fa fa-chrome"> </i> SISDATA</span>
            </a>
            <nav class="navbar navbar-static-top" role="navigation">
                <div class="collapse navbar-collapse pull-left"
                    style="padding-top: 10px; padding-left: 300px; font-size:20px; color: #FFFFF5;">
            ...
            <section class="content">
                ...
                <div class="error-page">
                    ...
                    <div class="error-content">
                        ...
                        <p>
                            La Dirección a la que Ud. esta queriendo Ingresar a sido caducada, por favor ingrese al
                            Sistema |<a href="{{ url('/') }}"> SISDATA</a> .
                        </p>
