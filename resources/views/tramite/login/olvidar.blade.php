...
<body class="hold-transition register-page" style="background-color: #FFF;">
    ...
    <div class=" register-box" style="opacity:0.75; background-color: #b3e5c6;">
        ...
        <div>
            <h3 class="text-center text-muted">Contrase&ntilde;a olvidada</h3>
        </div>
        <div class="register-box-body" style="background-color:transparent !important;">
            <p class="text-center">Debe ingresar su n&uacute;mero de DNI y fecha de nacimiento</p>
            ...
            {!! Form::open(['url' => 'restaurar', 'method' => 'POST']) !!} {{ csrf_field() }}
            <div class="form-group has-feedback">
                <input class="form-control" type="number" name="adm_dni" id="adm_dni"
                    onKeyPress="if(this.value.length==8) return false;" placeholder="Ingrese su número de DNI" required>
                ...
                <div class="col-xs-12">
                    <div class="box-footer">
                        <button class="btn btn-success btn-flat btn-block" type="submit" id="guardar"><i
                                class="fa fa-sign-out"></i> Restaurar Contraseña</button>
                        <a href="./" class="btn btn-primary btn-flat btn-block"><i class="fa fa-exchange"></i>
                            Volver</a>
                    </div>
                </div>
                <!-- /.col -->
            ...
            <div class="social-auth-links text-center">
                <button class="btn btn-success btn-block" type="submit" id="guardar">
                    <i class="glyphicon glyphicon-refresh"></i> Restaurar Contrase&ntilde;a
                </button>
