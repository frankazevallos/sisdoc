                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="header-row-td" width="378"
                                                                                ...
                                                                                valign="top" align="left">Hola!</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <div
                                                                    style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                                    <b style="color: #777777;">Estas recibiendo este
                                                                        correo porque recibimos una solicitud de
                                                                        restablecimiento de contraseña para tu
                                                                        cuenta.</b>
                                                                    <br> Por favor confirma haciendo click en el
                                                                    siguiente bot&oacute;n.
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                        ...
                                                        <tr>
                                                            <td class="table-col-td" width="378"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="{{ url('recibirpass/' . $verif_user->verification_token) }}"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td width="100%" align="center"
                                                                                ...
                                                                                valign="top">
                                                                                <a href="https://muniamarilis.gob.pe"
                                                                                    style="color: #428bca; text-decoration: none; background-color: transparent;">Municipalidad
                                                                                    Distrital de Amarilis - Huanuco
                                                                                </a>
                                                                                <br>
...
{{-- Siga el link para resetear tu contrase&ntilde;a {{ url('recibirpass/' . $verif_user->verification_token) }} --}}
