@extends('layouts.admin') @section('contenido') {!! Form::open(array('url' => 'tramite/administracion/usuarios', 'method' =>'POST')) !!} {{csrf_field()}}
<style>
                    ...
                    <div class="tab-content">
                        <div class="chart tab-pane active" id="buscar">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="adm_nombre" id="adm_nombre" placeholder="Ingrese los Nombres del Usuario." required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="adm_apellido">2. Apellidos</label>
                                <input type="text" class="form-control" name="adm_apellido" id="adm_apellido" placeholder="Ingrese los Apellidos del Usuario." required>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input class="form-control" type="number" name="adm_dni" id="adm_dni" onKeyPress="if(this.value.length==8) return false;" placeholder="Ingrese el DNI del Usuario." required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="adm_cumpleanos">5. Fecha de Nacimiento</label>
                                <input type="date" class="form-control" name="adm_cumpleanos" id="adm_cumpleanos" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="adm_telefono">6. Telefono (Cel.)</label>
                                <input type="text" class="form-control" name="adm_telefono" id="adm_telefono" placeholder="Ingrese el N° de Telefono o Celular del Usuario" maxlength="10">
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="adm_cargo" id="adm_cargo" placeholder="Ingrese el Cargo del Usuario" required>
                            </div>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="email" class="form-control" name="adm_email" id="adm_email" placeholder="Ingrese su correo Electronico" required>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="password" class="form-control" name="repit_password" id="repit_password" placeholder="Repita la Contraseña" required>
                            ...
                            <div class="col-xs-12">
                                <div class="box-footer1">
                                    ...
                                    <button class="btn btn-success pull-right" type="submit" id="guardar"><i class="fa fa-sign-out"></i> Guardar</button>
                                </div>
