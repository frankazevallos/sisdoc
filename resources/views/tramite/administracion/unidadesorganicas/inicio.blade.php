...
<div class="content">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Unidades Orgámicas</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Unidad Orgánica</a></li>
                        <li><a href="{{url('tramite/administracion/unidadesorg/create')}}">Nueva Unidad Orgánica</a></li>
                    </ul>
                        ...
                        <table id="example1" class="table table-bordered table-mihover">
                            ...
                            <tbody>
                            	...
                            	<tr onclick="marcar(this)">
                            		...
                            		<td>{{$dependencia->depe_siglaxp}}</td>
                            		<td>{{$dependencia->depe_representante}}</td>
                            		<td>{{$dependencia->depe_cargo}}</td>
                            		<td>{{$dependencia->getdependencia->depe_nombre}}</td>
                            		<td class="text-center">
                            			<div class="timeline-footer">
                                            {!! Form::open([ 'method' => 'DELETE', 'action' => ['UnidadesOrgController@destroy', $dependencia->iddependencia]]) !!} {{csrf_field()}}
                                                <a class="btn btn-primary btn-xs" href="{{url('tramite/administracion/unidadesorg/'.$dependencia->iddependencia.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a> |
...
<script>
    ...
    $(document).ready(function() {
        $(".del").click(function(event) {
            if (!confirm("¿ Realmente desea Eliminar la Unidad Orgánica Seleccionada ?"))
