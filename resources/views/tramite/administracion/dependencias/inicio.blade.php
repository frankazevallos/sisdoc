            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Dependencias</a></li>
                        <li><a href="{{url('tramite/administracion/dependencias/create')}}">Nueva Dependencia</a></li>
                    </ul>
                        ...
                        <table id="example1" class="table table-bordered table-mihover">
                            ...
                            <tbody>
                            	...
                            	<tr onclick="marcar(this)">
                            		<td class="text-center">{{$dependencia->iddependencia}}</td>
                            		...
                            		<td class="text-center">
                            			<div class="timeline-footer">
                                            {!! Form::open([ 'method' => 'DELETE', 'action' => ['DependenciasController@destroy', $dependencia->iddependencia]]) !!} {{csrf_field()}}
                                                <a class="btn btn-primary btn-xs" href="{{url('tramite/administracion/dependencias/'.$dependencia->iddependencia.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a> |
...
<script>
    ...
    $(document).ready(function() {
        $(".del").click(function(event) {
            if (!confirm("¿ Realmente desea Eliminar la Dependencia Seleccionada ?"))
