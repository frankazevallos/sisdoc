@extends('layouts.admin') @section('contenido') {!! Form::open(array('url' => 'tramite/administracion/entidadesext/'.$entidad->iddependencia, 'method' =>'PUT')) !!} {{csrf_field()}}
<style>
                    ...
                    <div class="tab-content">
                        <div class="chart tab-pane active" id="buscar">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" name="depe_nombre" id="depe_nombre" value="{{$entidad->depe_nombre}}" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="depe_abreviado">2. Abreviatura</label>
                                <input type="text" class="form-control" name="depe_abreviado" id="depe_abreviado" value="{{$entidad->depe_abreviado}}" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="depe_siglaxp">3. Siglas de la Entidad</label>
                                <input type="text" class="form-control" name="depe_siglaxp" id="depe_siglaxp" value="{{$entidad->depe_siglaxp}}">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="depe_representante">4. Representante</label>
                                <input type="text" class="form-control" name="depe_representante" id="depe_representante" value="{{$entidad->depe_representante}}" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="depe_cargo">5. Cargo</label>
                                <input type="text" class="form-control" name="depe_cargo" id="depe_cargo" value="{{$entidad->depe_cargo}}" required>
                            </div>
                            <div class="form-group col-sm-6">
