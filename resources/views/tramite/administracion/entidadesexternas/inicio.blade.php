...
<div class="content">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Entidades Externas</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Entidades Externas</a></li>
                        <li><a href="{{url('tramite/administracion/entidadesext/create')}}">Nueva Entidad Externa</a></li>
                    </ul>
                            		...
                            		<td class="text-center">
                                        <div class="timeline-footer">
                                            {!! Form::open([ 'method' => 'DELETE', 'action' => ['EntidadesExtController@destroy', $entidad->iddependencia]]) !!} {{csrf_field()}}
                                                <a class="btn btn-primary btn-xs" href="{{url('tramite/administracion/entidadesext/'.$entidad->iddependencia.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a> |
