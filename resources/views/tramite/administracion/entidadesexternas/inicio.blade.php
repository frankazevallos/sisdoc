    ...
    <div class="content">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Entidades Ext. / Ciudadano</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#">Buscar Entidades Ext. / Ciudadano</a></li>
                            <li><a href="{{ url('tramite/administracion/entidadesext/create') }}">Nueva Entidades Ext. /
                                    Ciudadano</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            <div class="chart tab-pane active" id="buscar">
                                    ...
                                    <tbody>
                                        @foreach ($entidades as $entidad)
                                            <tr onclick="marcar(this)">
                                                <td class="text-center">{{ $entidad->iddependencia }}</td>
                                                <td>{{ $entidad->depe_nombre }}</td>
                                                <td>{{ $entidad->depe_abreviado }}</td>
                                                <td>{{ $entidad->depe_siglaxp }}</td>
                                                <td>{{ $entidad->depe_representante }}</td>
                                                <td class="text-center">
                                                    <div class="timeline-footer">
                                                        {!! Form::open(['method' => 'DELETE', 'action' => ['EntidadesExtController@destroy', $entidad->iddependencia]]) !!} {{ csrf_field() }}
                                                        <a class="btn btn-primary btn-xs"
                                                            href="{{ url('tramite/administracion/entidadesext/' . $entidad->iddependencia . '/edit') }}"
                                                            title="Editar"><i class="fa fa-edit"></i></a> |
                                                        <button type="submit" class="btn btn-danger btn-xs del"
                                                            title="Eliminar" style="padding-left:7px; padding-right:7px;"><i
                                ...
                                <div class="box-footer1">
                                    <a href="{{ url('tramite/administracion') }}">
                                        <button type="button" class="btn btn-default pull-left"><i
                                                class="fa fa-exchange"></i> Volver</button>
                                    </a>
                                    <a href="{{ url('tramite') }}">
                                        <button type="button" class="btn btn-danger pull-right"><i
                                                class="fa fa-sign-out"></i> Salir</button>
                                    </a>
                                </div>
                                <!-- /.box -->
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".del").click(function(event) {
                if (!confirm("¿ Realmente desea Eliminar la Entidad Externa Seleccionada ?"))
