...
<div class="content">
    ...
    <section class="content">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <h4>	<i class="icon fa fa-check"></i> ATENCIÓN!</h4> {{ Session::get('msg') }}
        </div>
        @endif
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Tipo de Documento</a></li>
                        <li><a href="{{url('tramite/catalogos/tipodocumentos/create')}}">Nuevo Tipo de Documento</a></li>
                    </ul>
                        ...
                        <table id="example1" class="table table-bordered table-mihover">
                            ...
                            <tbody>
                                ...
                                <tr onclick="marcar(this)">
                                    <td class="text-center">{{ $tipoDoc->id }}</td>
                                    <td>{{ $tipoDoc->nombre }}</td>
                                    <td>{{ $tipoDoc->abreviar }}</td>
                                    <td class="text-center">
                                        <div class="timeline-footer">
                                            {!! Form::open([ 'method' => 'DELETE', 'action' => ['TipoDocumentoController@destroy', $tipoDoc->id]]) !!} {{csrf_field()}}
                                                <a class="btn btn-primary btn-xs" href="{{url('tramite/catalogos/tipodocumentos/'.$tipoDoc->id.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a> |
