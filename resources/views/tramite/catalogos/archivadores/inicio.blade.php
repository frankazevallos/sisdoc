...
<div class="content">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Archivadores</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">                        
                        <li class="active"><a href="#">Buscar Archivador</a></li>
                        <li><a href="{{url('tramite/catalogos/archivadores/create')}}">Nuevo Archivador</a></li>
                    </ul>
                        ...
                        <table id="example1" class="table table-bordered table-mihover">
                            <thead style="background-color: #69C57B;">
                                <tr>
									...
									<th class="text-center">UNID. ORG.</th>
									<th class="text-center">PERIODO</th>
									<th class="text-center">DE USUARIO</th>
							...
							<tbody>
								...
								<tr onclick="marcar(this)">
									<td class="text-center">{{ $archivador->idarch }}</td>
									<td>{{ $archivador->arch_nombre }}</td>
									<td>{{ $archivador->getdependencia->depe_nombre }}</td>
									<td>{{ $archivador->arch_periodo }}</td>
									@if($archivador->arch_idusuarioa >0)
										<td>{{ $archivador->getusuarioa->adm_nombre }}</td>
									@else
										<td></td>
									@endif
									<td class="text-center">                                            
										<div class="timeline-footer">
											{!! Form::open([ 'method' => 'DELETE', 'action' => ['ArchivadoresController@destroy', $archivador->idarch]]) !!} {{csrf_field()}}
												<a class="btn btn-primary btn-xs" href="{{url('tramite/catalogos/archivadores/'.$archivador->idarch.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a>
												|                                                
...
<script>
    ...
    $(document).ready(function() {
        $(".del").click(function(event) {
            if (!confirm("¿ Realmente desea Eliminar la Archivador Seleccionado ?"))
