...
<body class="hold-transition fixed skin-green sidebar-mini">
    	...
    	<div class="content" style="background-image: url({{asset('dist/img/bodyfond.jpg')}}); width: 100%; height: 100%; position: absolute;">  
			...
			@if(Session::has('exter'))
				<div class="content-header col-xs-10 col-sm-10 col-md-10 col-lg-10 col-md-offset-1 col-sm-offset-1 col-lg-offset-1">
			...
			<section class="content">
				<div class="row">
					<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 col-md-offset-1 col-sm-offset-1 col-lg-offset-1">
						...
						{!! Form::open(array('url' => 'externo/expedientes', 'method' =>'POST', 'name'=>'formu')) !!} {{csrf_field()}}
							...
							<div class="tab-content">
								<div class="chart tab-pane active" id="buscar">
									...
									<div class="form-group col-sm-6">
										...
										<div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="btn-interno" id="btn-interno" onClick="Cambia(this)" value="1"> Detalles
                                        </label>
                                    	</div>
		...
		<footer class="main-footer">
            <div class="pull-right hidden-xs">
              <b>SISDOC</b> | munimolino@gmail.com
            </div>
