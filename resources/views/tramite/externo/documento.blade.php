...
<body class="hold-transition fixed skin-green sidebar-mini">
									...
									<div class="chart tab-pane active" id="buscar">
										...
										<div class="col-xs-12">
											<div class="box-footer1">
												<a href="{{url('externo')}}" class="btn btn-danger"><i class="fa fa-sign-out"></i> Salir</a>
												<a href="{{url('externo/documentoprint/'.$documento->iddocumento)}}" class="btn btn-primary btn-flat pull-right" target="_blank"><i class="fa fa-print"></i> Imprimir</a>
												<hr width="0px">
											</div>
										</div>
									</div>
		...
		<footer class="main-footer">
            ...
            <strong>Municipalidad Distrtal de Molino <a href="{{url('tramite')}}"> SISDOC | 1.0</a>.</strong> Sistema de Gestión Documentaria.
        </footer>
