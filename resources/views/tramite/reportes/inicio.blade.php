            ...
            <div class="row">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body" id="buscar">
                            <div class="form-group col-sm-6 col-sm-offset-3">
                                ...
                                <select name="sel_reporte" id="sel_reporte" class="form-control"
                                    onChange="reporteOnch(this)">
                                    ...
                                    {{-- <option value="4">4. Documentos atendidos</option> --}}
                ...
                <div class="col-sm-12" style="display:none;" id="enProceso">
                    <div class="box box-success box-solid">
                        ...
                        <!-- /.box-header -->
                        {!! Form::open(['url' => 'tramite/reportes/enproceso', 'method' => 'post', 'name' => 'formu']) !!} {{ csrf_field() }}
                        <div class="box-body">
                            @if (Auth::user()->idadmin == 1)
                                <div class="form-group col-sm-6">
                                    <label for="en_iddependencia">1. Unidad Orgánica</label>
                                    <select class="form-control select2" name="en_iddependencia" id="en_iddependencia"
                                        style="width: 100%;">
                                        <option value>-- Seleccione una Opción --</option>
                                        @foreach ($unidades as $unidad)
                                            <option value="{{ $unidad->iddependencia }}">{{ $unidad->depe_nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            @else
                                <div class="form-group col-sm-6">
                                    ...
                                    <select class="form-control" name="en_iddependencia" readonly>
                                        <option value="{{ Auth::user()->adm_iddependencia }}">
                                            {{ Auth::user()->getdependencia->depe_nombre }}</option>
                                    </select>
                                </div>
                                <div class="form-group col-sm-6">
                                    <label for="en_idadmin">2. Usuario</label>
                                    <select class="form-control" name="en_idadmin" readonly>
                                        <option value={{ Auth::user()->idadmin }}>{{ Auth::user()->adm_nombre }}
                                            {{ Auth::user()->adm_apellido }}</option>
                                    </select>
                                </div>
                            @endif
                            <div class="form-group col-sm-6">
                        ...
                        <div class="box-footer">
                            <a href="{{ url('tramite') }}">
                                <button type="button" class="btn btn-default pull-left"><i class="fa fa-exchange"></i>
                                    Volver</button>
                            </a>
                            <button class="btn btn-success pull-right" type="submit"><i class="fa fa-file-pdf-o"></i>
                                Generar</button>
                        </div>
                        {!! Form::close() !!}
                    </div>
                ...
                <div class="col-sm-12" style="display:none;" id="porRecibir">
                    <div class="box box-primary box-solid">
                        ...
                        <!-- /.box-header -->
                        {!! Form::open(['url' => 'tramite/reportes/porrecibir', 'method' => 'post']) !!} {{ csrf_field() }}
                        <div class="box-body">
                            @if (Auth::user()->idadmin == 1)
                                <div class="form-group col-sm-6">
                                    <label for="en_iddependencia2">1. Unidad Orgánica</label>
                                    <select class="form-control select2" name="en_iddependencia2" id="en_iddependencia2"
                                        style="width: 100%;">
                                        <option value>-- Seleccione una Opción --</option>
                                        @foreach ($unidades as $unidad)
                                            <option value="{{ $unidad->iddependencia }}">{{ $unidad->depe_nombre }}
                        ...
                        <div class="box-footer box-footer2">
                            ...
                            <button class="btn btn-primary pull-right" type="submit"><i class="fa fa-file-pdf-o"></i>
                                Generar</button>
                        </div>
                        {!! Form::close() !!}
                        <!-- /.box-body -->
                ...
                <div class="col-sm-12" style="display:none;" id="docArchivados">
                    <div class="box box-warning box-solid">
                        ...
                        <!-- /.box-header -->
                        {!! Form::open(['url' => 'tramite/reportes/archivados', 'method' => 'post']) !!} {{ csrf_field() }}
                        <div class="box-body">
                            @if (Auth::user()->idadmin == 1)
                                <div class="form-group col-sm-6">
                                    <label for="en_iddependencia3">1. Unidad Orgánica</label>
                                    <select class="form-control select2" name="en_iddependencia3" id="en_iddependencia3"
                                        style="width: 100%;">
                                        <option value>-- Seleccione una Opción --</option>
                                        @foreach ($unidades as $unidad)
                                            <option value="{{ $unidad->iddependencia }}">{{ $unidad->depe_nombre }}
                        ...
                        <div class="box-footer box-footer3">
                            ...
                            <button class="btn btn-warning pull-right" type="submit"><i class="fa fa-file-pdf-o"></i>
                                Generar</button>
                        </div>
                        {!! Form::close() !!}
                    </div>
                ...
                <div class="col-sm-12" style="display:none;" id="uniOrganica">
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-footer box-footer4">
                            ...
                            <a href="{{ url('tramite') }}">
                                <button type="button" class="btn btn-danger pull-right"><i class="fa fa-file-pdf-o"></i>
                                    Generar</button>
                            </a>
                        </div>
                    </div>
                ...
                $.post(
                    ...
                    function(resp) {
                        ...
                        $.each(obj, function(key, value) {
                            option = option + '<option value="' + value['idadmin'] + '">' +
                                value['adm_nombre'] + '  ' + value['adm_apellido'] +
                                '</option>';
                        });
