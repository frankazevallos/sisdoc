...
<div class="content">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a class="text-green" href="{{url('tramite/documentos/recibidos')}}">Recibidos</a></li>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li><a href="{{url('tramite/documentos/recibidos')}}">Buscar Documentos Recibidos</a></li>
                    ...
                    <div class="tab-content">
                        <div class="chart tab-pane active" id="buscar">
                            ...
                            <div class="form-group col-sm-6">
								<label for="oper_depeid_d">Unidad Orgánica Destino</label>
                            ...
                            <div class="form-group col-sm-6">
								<label for="oper_usuid_d">Usuario Destino</label>
								<select class="form-control" name="oper_usuid_d" id="oper_usuid_d" required>
									<option value> Seleccione Opción</option>
								</select>                                
							</div>       
                            <div class="form-group col-sm-6">
								<label for="oper_detalledestino">Detalle</label>
                            ...
                            <div class="col-xs-12">
                                <div class="box-footer1">
                                    <a href="{{url('tramite/documentos/recibidos')}}" class="btn btn-default"><i class="fa fa-exchange"></i> Volver</a>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#oper_depeid_d").change(function(){
			 $("#oper_usuid_d").empty();
			$.post(
			  "{{url('tramite/documentos/recibidos/usuarios')}}",
