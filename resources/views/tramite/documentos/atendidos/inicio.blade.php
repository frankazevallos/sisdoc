                        	...
                        	<thead>
                        		<tr>
                        			...
                        			<td style="padding: 5px; padding-left: 80px;" class="pull-left">
                        				<a href="{{url('tramite/documentos/atendidos/derivar/'.Session::get('derivar')->idoperacion)}}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Documentos Atendidos</a></li>
                        <li><a href="#">Atendidos en el Día</a></li>
                        <li><a href="#">Atendidos en el Mes</a></li>
                    </ul>
                                ...
                                <tbody>
                                    ...
                                    <tr onclick="marcar(this)">
                                        ...
                                        @elseif($operacion->oper_idtope == 5)
                                            <td class="text-center">
                                                <span class="label label-success" style="font-size: 10px;">RECIBIDO</span>
                                            </td>
                                        @elseif($operacion->oper_idtope == 6)
                                            <td class="text-center">
                                                <span class="label label-success" style="font-size: 10px;">ATENDIDO</span>
                                            </td> 
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-default btn-xs" href="{{url('tramite/documentos/atendidos/archivar/'.$operacion->idoperacion)}}" title="Archivar"><i class="fa fa-file-zip-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
