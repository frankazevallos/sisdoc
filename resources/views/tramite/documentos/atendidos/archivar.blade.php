            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li><a href="{{url('tramite/documentos/recibidos')}}">Buscar Documentos en Recibidos</a></li>
                        <li class="active"><a href="#buscar" data-toggle="tab">Archivar Documento</a></li>
                    </ul>
                    
                    {!! Form::open(array('url' => 'tramite/documentos/recibidos/guardararchivado', 'method' =>'POST', 'name'=>'formu')) !!}
                    ...
                    <div class="tab-content">
                        <div class="chart tab-pane active" id="buscar">
                            ...
                            <div class="form-group col-sm-6">
								<label for="oper_tarchi_id">Forma</label>	
                            ...
                            <div class="form-group col-sm-6">
								<label for="oper_idarchivador">Archivador</label>	
                            ...
                            <div class="form-group col-sm-6">
								<label for="oper_acciones">Acciones</label>	
