                        	...
                        	<thead>
                        		<tr>
                        			...
                        			<td style="padding: 5px; padding-left: 80px;" class="pull-left">
                        				<a href="{{url('tramite/documentos/derivados/derivar/'.Session::get('derivar')->idoperacion)}}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Documentos Derivados</a></li>
                        <li><a href="#">Derivados en el Día</a></li>
                        <li><a href="#">Derivados en el Mes</a></li>
                    </ul>
