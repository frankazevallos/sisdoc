                        	...
                        	<thead>
                        		<tr>
                        			...
                        			<td style="padding: 5px; padding-left: 80px;" class="pull-left">
                        				<a href="{{url('tramite/documentos/enproceso/derivar/'.Session::get('derivar')->idoperacion)}}">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#">Buscar Documentos en Proceso</a></li>
                        <li><a href="{{url('tramite/documentos/enproceso/create')}}">Nuevo Documento</a></li>
                    </ul>
                            ...
                            <table id="example1" class="table table-bordered table-mihover table-condensed">
                                ...
                                <tbody>
                                    ...
                                    <tr onclick="marcar(this)">
                                        ...
                                        @elseif($operacion->oper_idtope == 4)
                                            <td class="text-center">
                                                <span class="label label-danger" style="font-size: 10px;">ARCHIVADO</span>
                                            </td>
                                        @elseif($operacion->oper_idtope == 5)
                                            <td class="text-center">
                                                <span class="label label-danger" style="font-size: 10px;">RECIBIDO</span>
                                            </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-primary btn-xs" href="{{url('tramite/documentos/enproceso/'.$operacion->oper_iddocumento.'/edit')}}" title="Editar"><i class="fa fa-edit"></i></a>
                                            
                                            <a class="btn btn-success btn-xs" href="{{url('tramite/documentos/enproceso/derivar/'.$operacion->idoperacion)}}" title="Derivar"><i class="fa fa-external-link-square"></i></a>
                                            
                                            {!! Form::open(array('url' => 'tramite/documentos/enproceso/eliminarderivado', 'method' =>'POST', 'class' =>'form-group')) !!} {{csrf_field()}}
                                            ...
                                            <a class="btn btn-warning btn-xs" href="{{url('tramite/documentos/enproceso/adjuntar/'.$operacion->idoperacion)}}" title="Adjuntar"><i class="fa fa-paste"></i></a>
                                            
                                            <a class="btn btn-default btn-xs" href="{{url('tramite/documentos/enproceso/archivar/'.$operacion->idoperacion)}}" title="Archivar"><i class="fa fa-file-zip-o"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
