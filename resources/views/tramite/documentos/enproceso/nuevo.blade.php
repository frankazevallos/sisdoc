            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="nav-tabs-custom">
                        ...
                        {!! Form::open(['url' => 'tramite/documentos/enproceso', 'method' => 'POST', 'name' => 'formu', 'files' => true]) !!} {{ csrf_field() }}
                        ...
                        <div class="tab-content">
                            <div class="chart tab-pane active" id="buscar">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date" class="form-control" id="docu_fecharegistro"
                                            name="docu_fecharegistro" value="{{ date('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="radio" id="divRadios">
                                        ...
                                        @if (Auth::user()->adm_iddependencia == '5' || Auth::user()->adm_iddependencia == '6')
                                            <label style="padding-right: 1cm;">
                                                <input type="radio" name="docu_idorigen" value="1" onchange="interno(this)">
                                                Interno
                                            </label>

                                            <label>
                                                <input type="radio" name="docu_idorigen" value="2" checked
                                                    onchange="externo(this)"> Externo
                                            </label>
                                            {{-- @elseif(Auth::user()->adm_iddependencia != '2') --}}
                                        @elseif(Auth::user()->adm_iddependencia != '5' && Auth::user()->adm_iddependencia != '6')
                                            <label style="padding-right: 1cm;">
                                                <input type="radio" name="docu_idorigen" value="1" checked
                                ...
                                @if (Auth::user()->adm_iddependencia == '5' || Auth::user()->adm_iddependencia == '6')
                                    ...
                                    <div id="interno" style="display:none">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="hidden" class="form-control"
                                                value="{{ Auth::user()->getdependencia->iddependencia }}"
                                                name="docu_iddependencia" id="docu_iddependencia" readonly>
                                            <input type="text" class="form-control"
                                                value="{{ Auth::user()->getdependencia->depe_nombre }}"
                                                name="docu_nomdependencia" id="docu_nomdependencia" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="docu_tipo" id="docu_tipo"
                                                        onClick="Cambia(this)" value="1"> Documento Personal
                                                </label>
                                            </div>
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="docu_firma">Firma</label>
                                            <input type="text" class="form-control" name="docu_firma" id="docu_firma"
                                                value="{{ $representante->depe_representante }}">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="docu_cargo">Cargo</label>
                                            <input type="text" class="form-control" name="docu_cargo" id="docu_cargo"
                                                value="{{ $representante->depe_cargo }}">
                                        </div>
                                    </div>
                                    <!--Ocultar-->
                                    ...
                                    <div id="externo" style="display:block">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="docu_detalle" id="docu_detalle"
                                                placeholder="Ingrese el Detalle del Documento Actual">
                                        </div>
                                        <div class="form-group col-sm-6">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input class="form-control" type="number" name="docu_ext_dni" id="docu_ext_dni"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select name="docu_idtipodocumento" id="docu_idtipodocumento"
                                        ...
                                        @foreach ($tipodocs as $tipodoc)
                                            <option value="{{ $tipodoc->idtdoc }}">{{ $tipodoc->tdoc_descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-5">
                                            <input type="text" name="docu_numero_doc" id="docu_numero_doc"
                                                class="form-control" placeholder="Ingrese el N° del Documento">
                                        </div>
                                        <div class="col-sm-7">
                                            <input type="text" name="docu_siglas_doc" id="docu_siglas_doc"
                                                class="form-control" value="MDA/">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="number" class="form-control" name="docu_folios" id="docu_folios"
                                        placeholder="Ingrese el N° de Folios del Documento"
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" class="form-control" name="docu_asunto" id="docu_asunto"
                                        placeholder="Ingrese el Asunto del Documento" required>
                                </div>
                                <div class="form-group col-sm-6">
                                    ...
                                    <select name="docu_idprioridad" id="docu_idprioridad" class="form-control" required>
                                        ...
                                        @foreach ($prioridades as $prioridad)
                                            <option value="{{ $prioridad->idprioridad }}">
                                                {{ $prioridad->prio_descripcion }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!--<div class="form-group col-sm-6">
                                ...
                                <div class="col-xs-12">
                                    <div class="box-footer1">
                                        <a href="{{ url('tramite/documentos/enproceso') }}" class="btn btn-default"><i
