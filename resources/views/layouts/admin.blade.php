    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="collapse navbar-collapse pull-left" style="padding-top: 10px; padding-left: 100px; font-size:20px; color: #FFFFF5;">  
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">                              
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"> {{Auth::user()->adm_nombre}} <i class="fa fa-sort-desc"></i></span>
                            </a>
                            
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="{{asset('dist/img/usuario-molino.png')}}" class="img-circle" alt="User Image">
                                    <p>
                                        {{Auth::user()->adm_nombre}} {{Auth::user()->adm_apellido}}
                                        <small style="font-size: x-small;">{{Auth::user()->getdependencia->depe_nombre}}</small>
                                ...
                                <li class="user-footer"> 
                                    <div class="pull-left">                                     
                                        <a href="{{url('tramite/password/edit')}}" style="font-size: x-small;"><u>Cambiar Contraseña</u></a>    
                                    </div>                                  
                ...
                <?php
                 $count0 = DB::table('tram_operacion') ->where('oper_idtope', '=', 3) -> where('oper_procesado', '=', 'f')-> where('oper_iddependencia', '=', Auth::user()->adm_iddependencia)->get()-> count();
                 
                 $count1 = DB::table('tram_operacion') ->where('oper_idtope', '=', 1) -> where('oper_procesado', '=', 'f')-> where('oper_iddependencia', '=', Auth::user()->adm_iddependencia)->get()-> count();
                 $total = $count0 + $count1;
                ...
                <?php
                 $count3 = DB::table('tram_operacion') ->where('oper_idtope', '=', 2) -> where('oper_procesado', '=', 'f')-> where('oper_usuid_d', '=', Auth::user()->idadmin)->get()-> count();
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown messages-menu">                           
                            <a href="{{url('tramite/documentos/porrecibir')}}" title="Recibir Documentos">
                                ...
                                <i class="fa fa-bell-o"><span class="label label-danger"><?php
                                    echo $count3; ?></span></i>
                ...
                <?php
                 $count4 = DB::table('tram_operacion') ->where('oper_idtope', '=', 5) -> where('oper_procesado', '=', 'f')-> where('oper_iddependencia', '=', Auth::user()->adm_iddependencia)->get()-> count();
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">                           
                            <a href="{{url('tramite/documentos/recibidos')}}" title="Atender Documentos">
                                ...
                                <i class="fa fa-flag-o"><span class="label label-primary"><?php
                                    echo $count4; ?></span></i>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                {!! Form::open(array('url' => 'tramite/buscar/documento', 'method' =>'POST', 'class'=>'sidebar-form')) !!} {{csrf_field()}}                
                <!-- Sidebar user panel -->
                ...
                {!! Form::open(array('url' => 'tramite/buscar/documento', 'method' =>'POST', 'class'=>'sidebar-form')) !!} {{csrf_field()}}
                    <div class="input-group">
                        <input type="text" name="buscar_doc" id="buscar_doc" class="form-control" placeholder="Buscar Documento">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> En proceso</a>
                            	<!--<ul class="treeview-menu">
                            ...
                            <li><a href="{{url('tramite/documentos/porrecibir')}}"><i class="fa fa-circle-o text-green"></i> Por recibir</a>
                            	<!--<ul class="treeview-menu">
                                    <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> Buscar</a></li>
                                    <li><a href="{{url('tramite/documentos/enproceso/create')}}"><i class="fa fa-circle-o text-green"></i> Nuevo</a></li>
                                </ul>-->
                            ...
                            <li><a href="{{url('tramite/documentos/recibidos')}}"><i class="fa fa-circle-o text-green"></i> Recibidos</a>
                                <!--<ul class="treeview-menu">
                                    <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> Buscar</a></li>
                                    <li><a href="{{url('tramite/documentos/enproceso/create')}}"><i class="fa fa-circle-o text-green"></i> Nuevo</a></li>
                                </ul>-->
                            ...
                            @endif
                            <li><a href="{{url('tramite/documentos/derivados')}}"><i class="fa fa-circle-o text-green"></i> Derivados</a>
                                <!--<ul class="treeview-menu">
                                    <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> Buscar</a></li>
                                    <li><a href="{{url('tramite/documentos/enproceso/create')}}"><i class="fa fa-circle-o text-green"></i> Nuevo</a></li>
                                </ul>-->
                            ...
                            @if(Auth::user()->adm_iddependencia != '2')
                            <li><a href="{{url('tramite/documentos/atendidos')}}"><i class="fa fa-circle-o text-green"></i> Atendidos</a>
                                <!--<ul class="treeview-menu">
                                    <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> Buscar</a></li>
                                    <li><a href="{{url('tramite/documentos/enproceso/create')}}"><i class="fa fa-circle-o text-green"></i> Nuevo</a></li>
                                </ul>-->
                            ...
                            @endif
                            <li><a href="{{url('tramite/documentos/archivados')}}"><i class="fa fa-circle-o text-green"></i> Archivados</a>
                            	<!--<ul class="treeview-menu">
                                    <li><a href="{{url('tramite/documentos/enproceso')}}"><i class="fa fa-circle-o text-green"></i> Buscar</a></li>
                                    <li><a href="{{url('tramite/documentos/enproceso/create')}}"><i class="fa fa-circle-o text-green"></i> Nuevo</a></li>
                                </ul>-->
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('tramite/catalogos/archivadores')}}"><i class="fa fa-circle-o text-green"></i> Archivadores</a>
                                <!-- <ul class="treeview-menu">
                            ...
                            <li><a href="{{url('tramite/catalogos/tipodocumentos')}}"><i class="fa fa-circle-o text-green"></i> Tipos de Documentos</a>
                                <!-- <ul class="treeview-menu">
                            ...
                            <li><a href="{{url('tramite/catalogos/tipoprioridad')}}"><i class="fa fa-circle-o text-green"></i> Tipos de Prioridades</a>
                                 <!-- <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{url('tramite/administracion/entidadesext')}}"><i class="fa fa-circle-o text-green"></i> Entidades Externas</a>
                            	<!-- <ul class="treeview-menu">
                                ...
                                @if(Auth::user()->idadmin == 1)
                                <li><a href="{{url('tramite/administracion/unidadesorg')}}"><i class="fa fa-circle-o text-green"></i> Unidades Orgánicas</a>
                            	<!-- <ul class="treeview-menu">
                                ...
                                <li><a href="{{url('tramite/administracion/usuarios')}}"><i class="fa fa-circle-o text-green"></i> Usuarios</a>
                            	<!-- <ul class="treeview-menu">
                                ...
                                <li><a href="{{url('tramite/administracion/dependencias')}}"><i class="fa fa-circle-o text-green"></i> Dependencia</a>
                            	<!-- <ul class="treeview-menu">
