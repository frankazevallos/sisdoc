...
class EnProcesoController extends Controller
{
    ...
    {
		$operaciones = Operacion::whereIn('oper_idtope', [1, 3])->where('oper_procesado', '=', 'f')->where('oper_iddependencia', '=', Auth::user()->adm_iddependencia)->get();
		
        return view('tramite.documentos.enproceso.inicio', ['operaciones'=>$operaciones]);
    }
    ...
    public function create()
    {
        ...
        return view('tramite.documentos.enproceso.nuevo', ['prioridades'=>$prioridades, 'externas'=>$externas, 'representante'=>$representante, 'tipodocs'=>$tipodocs]);
    }
		...
		try{
			...
			if ($request->hasFile('file_archivo')) {
				if ($request->file('file_archivo')->isValid()) {
					...
					return redirect('tramite/documentos/enproceso')->with('derivar', $derivar);	
				}
				else{ return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar crear el Documento intente nuevamente.'); }
			}
			else{ 
				return redirect('tramite/documentos/enproceso')->with('error', 'No se encontro ningun Archivo para Guardar intente Nuevamente'); 
			}			
		}
		catch(\Exception $e){
			DB::rollBack();
    ...
    {
        return view('tramite.documentos.enproceso.aviso');
    }
	...
	public function derivar($id)
	{
        ...
        return view('tramite.documentos.enproceso.derivar', ['organicas'=>$organicas, 'operacion'=>$operacion]);
    }
	...
	public function guardarderivado(Request $request)
	{
		try{
			...
			return redirect('tramite/documentos/enproceso')->with('msg', 'El Documento fue Derivado Satisfactoriamente');
		}
		catch(\Exception $e){
			DB::rollBack();
			
			return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar Derivar el Documento, intente nuevamente o contactece con el Administrador del Sistema');
		}
	}
	...
	public function eliminarderivado(Request $request)
	{
		try{
			...
			return redirect('tramite/documentos/enproceso')->with('msg', 'La Derivación fue Eliminado Satisfactoriamente');
		}
		catch(\Exception $e){
			DB::rollBack();
			
			return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar eliminar la Derivación el Documento, intente nuevamente o contactece con el Administrador del Sistema');
		}
    }
    ...
    public function edit($id)
    {
		...
		$externas = Dependencias::where('depe_tipo', '=', 2)->get();
		$representante = Dependencias::select('depe_representante', 'depe_cargo')->where('iddependencia', '=', Auth::user()->adm_iddependencia)->first();
        return view('tramite.documentos.enproceso.editar', ['prioridades'=>$prioridades, 'externas'=>$externas, 'representante'=>$representante, 'tipodocs'=>$tipodocs, 'documento'=>$documento]);
    }
    ...
    public function update(Request $request, $id)
    {
        try{
			...
			return redirect('tramite/documentos/enproceso')->with('msg', 'El Documento fue Editado Satisfactoriamente');
		}
		catch(\Exception $e){
			DB::rollBack();
			
			return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar editar el Documento contactece con el Administrador del Sistema');
		}
    }
	...
	{
		$operacion = Operacion::where('idoperacion', '=', $id)->first();
        return view('tramite.documentos.enproceso.adjuntar', ['operacion'=>$operacion]);
    }
	...
	public function guardaradjuntado(Request $request)
	{
		try{
			...
			return redirect('tramite/documentos/enproceso')->with('msg', 'El Documento fue Adjuntado Satisfactoriamente');
		}
		catch(\Exception $e){
			DB::rollBack();
			
			return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar Adjuntar el Documento, intente nuevamente o contactece con el Administrador del Sistema');
		}
	}
	...
	public function archivar($id)
	{
        ...
        return view('tramite.documentos.enproceso.archivar', ['operacion'=>$operacion, 'archivadores'=>$archivadores]);
    }
	...
	{		
		try{
			...
			return redirect('tramite/documentos/enproceso')->with('msg', 'El Documento fue Archivado Satisfactoriamente');
		}
		catch(\Exception $e){
			DB::rollBack();
			
			return redirect('tramite/documentos/enproceso')->with('error', 'Hubo un error al intentar Archivar el Documento, intente nuevamente o contactece con el Administrador del Sistema');
		}
	}
